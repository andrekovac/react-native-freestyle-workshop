...
const Animation02_interruptible_and_cancellable = () => {
    ...
    <View style={{ backgroundColor: '#ece' }}>
      <Button
        onPress={() => {
          ...
          const newOffsetValue = withTiming(Math.random() * 150, config, () =>
...
export default Animation02_interruptible_and_cancellable;
